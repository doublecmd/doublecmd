...
* Wed Dec 12 2007 G�tz Waschk <goetz@zarb.org> 3.71-0.beta1.1plf2008.1
- new version

* Tue Nov  6 2007 G�tz Waschk <goetz@zarb.org> 3.70-1plf2008.1
- new version

* Mon Apr 16 2007 G�tz Waschk <goetz@zarb.org> 3.70-0.beta7.1plf2007.1
- new version

* Tue Mar  6 2007 G�tz Waschk <goetz@zarb.org> 3.70-0.beta4.1plf2007.1
- new version

* Tue Feb  6 2007 G�tz Waschk <goetz@zarb.org> 3.70-0.beta3.1plf2007.1
- drop patch
- new version

* Wed Jan 24 2007 G�tz Waschk <goetz@zarb.org> 3.70-0.beta1.1plf2007.1
- don't strip the binary at build stage
- new version

* Thu Nov  2 2006 G�tz Waschk <goetz@zarb.org> 3.60-1plf2007.1
- update description
- new version

* Mon Jul 24 2006 G�tz Waschk <goetz@zarb.org> 3.60-0.beta7.1plf2007.0
- new version

* Wed Jun 28 2006 G�tz Waschk <goetz@zarb.org> 3.60-0.beta5.1plf2007.0
- new version

* Tue Oct 11 2005 G�tz Waschk <goetz@zarb.org> 3.51-1plf
- new version

* Tue Aug  9 2005 G�tz Waschk <goetz@zarb.org> 3.50-1plf
- new version

* Tue Apr 19 2005 G�tz Waschk <goetz@zarb.org> 3.50-0.beta1.1plf
- mkrel
- new version

* Mon Sep 20 2004 G�tz Waschk <goetz@zarb.org> 3.40-1plf
- fix description
- new version

* Sun Jun  6 2004 G�tz Waschk <goetz@plf.zarb.org> 3.30-2plf
- rebuild for new g++

* Wed Apr 21 2004 G�tz Waschk <goetz@plf.zarb.org> 3.30-1plf
- new version

* Tue Dec 30 2003 G�tz Waschk <goetz@plf.zarb.org> 3.20-2plf
- add unrar bash-completion for Cooker builds

* Fri Jun 20 2003 G�tz Waschk <goetz@plf.zarb.org> 3.20-1plf
- small build patch for gcc 3.3
- new version

* Sun Mar 30 2003 G�tz Waschk <goetz@plf.zarb.org> 3.20-0.beta2.1plf
- arrgh, the displayed version is 3.20 beta 2

* Sat Mar 29 2003 G�tz Waschk <goetz@plf.zarb.org> 3.2.0-0.beta2.1plf
- new version

* Fri Feb 14 2003 G�tz Waschk <goetz@plf.zarb.org> 3.10-2plf
- use default optimization flags (Francisco Javier Felix)

* Wed Jan  8 2003 G�tz Waschk <waschk@informatik.uni-rostock.de> 3.10-1plf


* Tue Dec  3 2002 G�tz Waschk <waschk@informatik.uni-rostock.de> 3.10-0.beta3.1plf
- 3.10 beta 3

* Tue Oct 22 2002 G�tz Waschk <waschk@informatik.uni-rostock.de> 3.10-0.beta1.1plf
- fix url
- add some docs
- drop patch
- quiet tar
